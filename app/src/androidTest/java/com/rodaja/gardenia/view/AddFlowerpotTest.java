...
public class AddFlowerpotTest {
    ...
    public void addFlowerpotTest(){
        ...
        ActivityTestRule<AddFlowerPot> activityRule = new ActivityTestRule<>(AddFlowerPot.class, true,true);
        Intent intent = new Intent();
        intent.putExtra("user", user);
        activityRule.launchActivity(intent);

        // Type text and then press the button.
        onView(withId(R.id.btn_confirmar_agregar)).perform(click());
    }
}
